...
The table below [ref] shows the obtained results varying the parameter C which balance the value of exploration and exploitation in the UCB formula.

\begin{table}[h]
\centering
\begin{tabular}{|l|l|l|l|l|l|l|l|l|}
\hline
\multicolumn{1}{|c|}{\multirow{2}{*}{Algo}} & \multirow{2}{*}{C} & \multirow{2}{*}{Budget} & \multirow{2}{*}{Success Rate} & \multicolumn{3}{c|}{Robustness} & \multicolumn{2}{c|}{Time} \\ \cline{5-9} 
\multicolumn{1}{|c|}{}                      &                    &                         &                               & min       & avg      & var      & tot        & trace        \\ \hline
URS                                         & -----              & 100                     & 1/10                          &           &          &          &            &              \\
MCTS+RS                                     & 0.500              & 100                     & 0/10                          &           &          &          &            &              \\
MCTS+HC                                     & 0.500              & 100                     & 7/10                          &           &          &          &            &              \\
MCTS+SA                                     & 0.500              & 100                     & 0/10                          &           &          &          &            &              \\ \hline
MCTS+RS                                     & 0.250              & 100                     & 0/10                          &           &          &          &            &              \\
MCTS+HC                                     & 0.250              & 100                     & 7/10                          &           &          &          &            &              \\
MCTS+SA                                     & 0.250              & 100                     & 0/10                          &           &          &          &            &              \\ \hline
MCTS+RS                                     & 0.125              & 100                     & 0/10                          &           &          &          &            &              \\
MCTS+HC                                     & 0.125              & 100                     & 7/10                          &           &          &          &            &              \\
MCTS+SA                                     & 0.125              & 100                     & 0/10                          &           &          &          &            &              \\ \hline
MCTS+RS                                     & 0.000              & 100                     & 0/10                          &           &          &          &            &              \\
MCTS+HC                                     & 0.000              & 100                     & 7/10                          &           &          &          &            &              \\
MCTS+SA                                     & 0.000              & 100                     & 0/10                          &           &          &          &            &              \\ \hline
\end{tabular}
\caption{Result of experiments. Comparison between MCTS and URS, varying the parameter C which balance exploration and exploitation in the UCB formula. The input signals have been split into 2 and 3 region.}
\end{table}
\pagebreak
